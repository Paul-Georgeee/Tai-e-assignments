...
public class _2TypeSelector implements ContextSelector {
    ...
    public Context selectContext(CSCallSite callSite, JMethod callee) {
        ...
        if(len == 0)
            ...
            return ListContext.make(context.getElementAt(0));
        else
            return ListContext.make(context.getElementAt(0), context.getElementAt(1));
    }
    ...
    public Context selectContext(CSCallSite callSite, CSObj recv, JMethod callee) {
        ...
        if(len == 0)
            ...
            return ListContext.make(context.getElementAt(0), recv.getObject().getContainerType());
        else
            return ListContext.make(context.getElementAt(1), recv.getObject().getContainerType());
    }
